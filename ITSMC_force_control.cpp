void ITSMC_REF_force_control(void)
{
    ...
    while (true)
    {
        ...
        dyn_mat_ER3B(pos, vel, d_robot, c_robot, g_robot, tau_f_v_robot, tau_f_c_robot,tau_f_b_robot);

        Eigen::Map<Eigen::MatrixXd> d_matri(d_robot, 6, 6);  
        ...
        Eigen::Map<Eigen::MatrixXd> J_matri(J, 6, 6);  
